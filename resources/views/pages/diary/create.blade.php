...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{route('diary.store')}}" method="POST" class="parsley-examples" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="person" placeholder="Mr. John Doe"
                                value="{{ old('person') }}" class="form-control" required >
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <textarea name="description"  class="form-control" cols="30" rows="1">{{ old('description') }}</textarea>
